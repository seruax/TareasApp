...
<body>
    ...
    <div class="container">
        ...
        <h1 class="p-3"> Editar Tarea </h1>

        <form:form action="/guardarTareaEditada" method="post" modelAttribute="tarea">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="fecha">Date</label>
            		<div class="col-md-6">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		<label class="col-md-3" for="estado">Status</label>
            		<div class="col-md-6">
    ...
    <script th:inline="javascript">
                window.onload = function() {
                    ...
                    var msg = "${mensaje}";
                    console.log(msg);
                    if (msg == "Error al editar") {
        				Command: toastr["error"]("No se ha podido editar.")
        			}
